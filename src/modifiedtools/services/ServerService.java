package modifiedtools.services;
...
public class ServerService {
    ...
    public void fetchServers() {
        try {
            Seq<Server> servers = Core.settings.getJson("modifiedtools.servers", Seq.class, Server.class, Seq::new);
            ...
            Http.get(Config.API_v4_URL + "servers?page=0&size=100")
                    ...
                    .submit(res -> {
                        try {
                            ...
                            Core.settings.putJson("modifiedtools.servers", Server.class, servers);
