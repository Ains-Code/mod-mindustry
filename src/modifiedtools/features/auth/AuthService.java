package modifiedtools.features.auth;
...
import modifiedtools.Config;
import modifiedtools.Utils;
import modifiedtools.features.auth.dto.LoginEvent;
import modifiedtools.features.auth.dto.LogoutEvent;
import modifiedtools.features.auth.dto.UserSession;
import modifiedtools.features.auth.dto.SessionLoadEvent;
import modifiedtools.ui.NetworkImage;
import arc.util.Http.HttpStatusException;

public class AuthService {
    private static AuthService instance;

    public static final String KEY_ACCESS_TOKEN = "modifiedtools.auth.access-token";
    public static final String KEY_REFRESH_TOKEN = "modifiedtools.auth.refresh-token";
    public static final String KEY_LOGIN_ID = "modifiedtools.auth.login-id";
    public static final String KEY_LOGIN_EXPIRY = "modifiedtools.auth.login-expiry";
