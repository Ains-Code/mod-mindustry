package modifiedtools.features.display.pathfinding;

import arc.Core;

public class PathfindingConfig {
    private static final String ZOOM_THRESHOLD_KEY = "modifiedtools.pathfinding.zoom-threshold";
    private static final String OPACITY_KEY = "modifiedtools.pathfinding.opacity";
    private static final String DRAW_UNIT_PATH_KEY = "modifiedtools.pathfinding.draw-unit-path";
    private static final String DRAW_SPAWN_POINT_PATH_KEY = "modifiedtools.pathfinding.draw-spawn-point-path";
    private static final String COST_TYPE_PREFIX = "modifiedtools.pathfinding.cost-type.";
