package modifiedtools.features.autoplay;
...
import modifiedtools.features.autoplay.tasks.*;
...
public class AutoplayFeature implements Feature {
    ...
    private boolean isFollowUnit = Core.settings.getBool("modifiedtools.autoplay.follow-unit", true);
    ...
    public void init() {
        ...
        Seq<String> savedOrder = Core.settings.getJson("modifiedtools.autoplay.task-order", Seq.class, Seq::new);
    ...
    public void setFollowUnit(boolean followUnit) {
        ...
        Core.settings.put("modifiedtools.autoplay.follow-unit", followUnit);
    }

    public void saveTaskOrder() {
        Seq<String> ids = new Seq<>();
        tasks.each(t -> ids.add(t.getId()));
        Core.settings.putJson("modifiedtools.autoplay.task-order", ids.toArray(String.class));
    }
}
