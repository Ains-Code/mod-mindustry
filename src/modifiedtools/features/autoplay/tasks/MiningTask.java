package modifiedtools.features.autoplay.tasks;
...
public class MiningTask implements AutoplayTask {
    ...
    public void init() {
        ...
        Seq<String> saved = Core.settings.getJson("modifiedtools.autoplay.task." + getId() + ".items", Seq.class,
                Seq::new);
    ...
    public void save() {
        ...
        Core.settings.putJson("modifiedtools.autoplay.task." + getId() + ".items", names.toArray(String.class));
    }
