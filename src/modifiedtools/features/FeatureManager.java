package modifiedtools.features;
...
public class FeatureManager {
    ...
    public void reEnable() {
        ...
        Seq<String> enableds = Core.settings.getJson("modifiedtools.enabled-features", Seq.class, String.class,
                Seq::new);
    ...
    public void disableAll() {
        ...
        Core.settings.putJson("modifiedtools.enabled-features", String.class, enableds);
