...
| File | Description |
|------|-------------|
| `features/campaign/CampaignFeature.java` | Campaign HUD panel: sector/planet capture progress, wave countdown, resource snapshot, expansion suggestions |
| `features/campaign/CampaignConfig.java` | Campaign feature configuration (position, toggles, wave warning threshold) |
| `features/campaign/CampaignSettingDialog.java` | Campaign settings UI |
